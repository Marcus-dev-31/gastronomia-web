...
const cursosLinks = [
  { href: "/cursos/pan-de-masa-madre", label: "Pan de Masa Madre" },
  { href: "/cursos/pizza", label: "Pizza" },
  { href: "/cursos/laminados", label: "Laminados" },
  { href: "/cursos/pan-casero-a-mano", label: "Pan Casero a Mano" },
];
